...
INT32 CSM_addService(CHAR * service_uuid,
...
INT32 CSM_addChar(INT32 service_handle,
...
INT32 CSM_addDesc(INT32 service_handle,
...
INT32 CSM_sendResponse(INT32 trans_id,INT32 status,
...
INT32 CSM_sendIndication(INT32 handle,
